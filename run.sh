...
echo "------------------------------------------------------------------------"
echo "Running inference on sample data directory..."
echo ""
python -u 04-inference.py /work/inference_data 2>&1 | tee -a ../log/run.log
echo ""
echo "✓ Inference complete"
echo "  Output: src/predictions/predictions.csv"
echo ""
...
echo "  • Training plots: src/training_plots/training_curves.png"
echo "  • Evaluation plots: src/evaluation_plots/"
echo "  • Model checkpoint: saved in lightning_logs/"
echo "  • Inference predictions: src/predictions/predictions.csv"
echo ""
echo "To view logs:"
echo "  tail -n 100 log/run.log"
echo ""
echo "To view training curves:"
echo "  open src/training_plots/training_curves.png"
echo ""
echo "To view evaluation results:"
echo "  open src/evaluation_plots/"
echo ""
echo "To view inference predictions:"
echo "  cat src/predictions/predictions.csv"
echo ""
